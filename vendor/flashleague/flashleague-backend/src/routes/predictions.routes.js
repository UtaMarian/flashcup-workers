...
const { getBoard, getBoardGroup, placePrediction, cancelPrediction, collectPrediction, collectReward } = require("../controllers/predictions.controller");
const { authenticate } = require("../middleware/auth");

const router = express.Router();

router.get("/board", authenticate, getBoard);
router.get("/board/:leagueId", authenticate, getBoardGroup);
